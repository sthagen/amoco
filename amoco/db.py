...
def createdb(url=None):
    ...
    if has_sql:
        ...
        logger.info("SQL Session available")
    else:
        logger.info("no Session defined")
        engine = None
    return engine
...
if has_sql:
    ...
    class FuncData(Base):
        ...
        def __repr__(self):
            ...
            return "<FuncData #{}: {:<.016} of Case #{}>".format(*s)
    ...
    class FuncInfo(Base):
        ...
        def __repr__(self):
            ...
            return "<FuncInfo #{}: {:<.016} with FuncData #{}>".format(*s)
    ...
    class CfgData(Base):
        ...
        def __repr__(self):
            ...
            return "<CfgData #{}: object related to Case #{}>".format(*s)
